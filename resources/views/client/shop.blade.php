        ...
        <div class="container">
                ...
                <div class="col-md-10 mb-5 text-center">
                    <ul class="product-category">
                        ...
                        @foreach ($categories as $category)
                            <li><a class="{{ (request()->is('view_by_cat/'.$category->category_name)?'active':'') }}" href="/view_by_cat/{{ $category->category_name }}">{{ $category->category_name }}</a></li>
                        @endforeach
            ...
            <div class="row">
                ...
                <div class="col-md-6 col-lg-3 ftco-animate">
                    <div class="product">
                        <a href="#" class="img-prod"><img class="img-fluid" src="/storage/product_image/{{ $product->product_image }}"
